...
<body>
	...
	저장된 객체의 갯수만큼 반복하여 list로 하나씩전달한다.
	 -->
	...
	*/
	...
	<%
	/*
	Map게열의 컬렉션을 생성한다. Key는 String, Value는 Person 타입으로 지정한다.
	*/
	...
	for(String key : keys){
		...
		/*
		Key와 Value를 출력한다. 여기서 value는 Person객체이므로 멤버변수에
		저장된 값은 getter를 통해 출력할 수 있다.
		*/
		out.println("Key => "+ key + "<br/>");
		out.println("Value =>" + p.getName() + ","+p.getAge() + "<br/>");
	}
	/*
	JSTL의 확장 for문을 사용하면 Key를 별도로 얻어와야 하는 번거로움이 없어지므로
	편리하다.
	*/
	%>
