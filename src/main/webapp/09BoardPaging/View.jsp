...
<input type="hidden" name="num" value="<%= num %>" />  
	<!-- DTO에 저장된 내요을 getter를 통해 웹브라우저에 출력한다. -->
    <table border="1" width="90%">
        ...
        <tr>
            <td colspan="4" align="center">
            	<%
            	/*
            	로그인이 된 상태에서 세션영역에 저장된 아이디가 해당 게시물을 작성한 하이디와 일치하면
            	수정, 삭제 버튼을 보이게 처리한다.
            	즉, 작성자 본인이 해당 게시물을 조회했을 때만 수정, 삭제 버튼이 보이게 처리한다.
            	*/
                ...
                <button type="button" onclick="location.href='Edit.jsp?num=<%=dto.getNum()%>';">
                    수정하기</button>
                <!-- 
                삭제하기 버튼을 누르면 JS의 함수를 호출한다. 해당 삼수는 submit()을 통해 폼값을 서버로
                전송한다.
                 -->
