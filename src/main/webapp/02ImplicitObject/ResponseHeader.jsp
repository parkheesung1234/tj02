...
/*
<form>태그를 통해 서버로 전송되는 값은 모두 String 타입이므로 숫자나 날짜형식의 연산이
필요한 경우에는 변환 후 사용해야한다.
*/
...
<body>
	...
	8282가 출력된다. 이것은 getHeader()메서드의 특성으로 처음 입력한 헤더값만
	출력하게된다.
	*/
	%>
	...
	<%
	/*
	myNumber라는 헤더명으로 2개의 값을 추가햇으므로 아래에서는 각각의 값이 정상적으로 출력된다.
