...
<ul>
	...
	<!--
	person객체를 출력하낟. 멤버변수명을 통해 getter()를 호출하여
...
<ul>
	...
	<!-- 단, 한글인 경우에는 앞에.(닷)을 사용할 수 없다. -->
	<li>한글 key : ${ King["한글""] }, ${ King['한글'] }, \${ King.한글 }<!-- 에러가 발생한다. --></li>
	<!-- EL식 앞에 \(역슬러쉬)를 붙이면 주석이 된다. 단, 코드가  숨겨지는 것은 ㅇ나ㅣ고
	코드가 그대로 화면에 출력된다. -->
</ul>
</body>
</html>