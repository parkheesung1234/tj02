...
$(function(){
   ...
   $('#btnLogin2').click(function(){
      ...
      /*
      jQuery의 Ajax관련 함수의 파라미터는 JSON형태로 조립한 후 서버로 전송해야한다.
      이때 <form>태그 하위의 모든 폼값을 한꺼번에 JSON으로 만들고 싶다면 serialize() 함수를 사용하면된다.
      */
      ...
      $.post(
         ...
         function(resData){
            ...
            $.post() 함수는 지정할 수 없어 무조건 text형식으로만 콜백받을수 있다.
...
function checkFrm(){
   var f = document.geElementById("loginFrm");
   f.method = "post";
