<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <!-- 
     ...
     여기서는 퍼버가 1kb(1000byte), 꽉 찬 경우 내보내기 하지 않도록 설정한 상태이다.
     -->
<!DOCTYPE html>
<html>
<head>
...
실행시 에러가 발행한다.
해결 방법은 buffer의 용량을 늘ㄹ리거나, autoFlush를 true로 변경한다.
*/
for (int i =1; i<=100; i++){
...
단, JSP가 웨브라우저에 내용을 출력할 때 버퍼를 사용하는 것을 인지하고,
이를 통해 에러페이지처리나 포워드 등의 기능을 수행할 수 있게된다.
*/
%>
</body>
</html>