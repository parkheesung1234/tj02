...
public class NaverSearchServlet extends HttpServlet{
   ...
   protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      //애플리케이션 클라이언트 아이디
        String clientId = "K5jDBgcjU5p1tJfqfKar"; 
        //애플리케이션 클라이언트 시크릿
        String clientSecret = "RRibycpl3B"; 
        ...
        결과를 받을것이므로 첫번째 주소로 요청한다. 파라미터는 query(검색어),
        ...
        */
        ...
        //서블릿에서 JSP없이 즉시 내용을 출력하기 위해 컨텐츠 타입을 설정한다.
   ...
   /* 아래에 있는 3개의 메서드는 수정없이 그대로 사용하면 된다. */
